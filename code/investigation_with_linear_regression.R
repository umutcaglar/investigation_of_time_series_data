...
#                       0.6 * dplyr::lag(x = r03, n = 4, default = 0)) -> main_data
...
df_r01 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r01", 
                      elemination_vars_ = elemination_vars)

df_r02 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r02", 
                      elemination_vars_ = elemination_vars)

df_r03 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r03", 
                      elemination_vars_ = elemination_vars)

df_r04 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r04", 
                      elemination_vars_ = elemination_vars)

df_r05 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r05", 
                      elemination_vars_ = elemination_vars)

df_r06 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r06", 
                      elemination_vars_ = elemination_vars)

df_r07 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r07", 
                      elemination_vars_ = elemination_vars)

df_r08 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r08", 
                      elemination_vars_ = elemination_vars)

df_r09 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r09", 
                      elemination_vars_ = elemination_vars)

df_r10 <- linear_fit_(df = main_data_ext, 
                      y_value_ = "r10", 
                      elemination_vars_ = elemination_vars)
